...
public class opr
{
    public static void main(final String[] args) throws IOException {
        ...
        frames = Integer.parseInt(io.nextLine());

        System.out.println("Please enter the length of the reference string: ");
        ref_len = Integer.parseInt(io.nextLine());
        ...
        for (int i = 0; i < ref_len; i++) {
            reference[i] = Integer.parseInt(io.nextLine());
        }
        System.out.println();
        for (int i = 0; i < ref_len; i++) {
            int search = -1;
            ...
            if (search == -1) {
                if (isFull) {
                    final int index[] = new int[frames];
                    final boolean index_flag[] = new boolean[frames];
